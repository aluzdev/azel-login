...
import { idlFactory } from './webapp.did.js';
export { idlFactory } from './webapp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WEBAPP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./webapp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the webapp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./webapp.did.js")._SERVICE>}
 */
export const webapp = createActor(canisterId);
